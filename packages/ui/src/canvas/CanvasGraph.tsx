...
const CANVAS_EDGE_STATE_CLASS =
  "[&_.react-flow__edge:hover]:[--canvas-edge-stroke:var(--primary)] [&_.react-flow__edge:hover]:[--xy-edge-stroke:var(--primary)] [&_.react-flow__edge.selected]:[--xy-edge-stroke:var(--primary)] [&_.react-flow__edge.selected]:[--xy-edge-stroke-selected:var(--primary)] [&_.react-flow__edgelabel-renderer]:!z-[1002]";
