...
| `resolveWikiLinkTarget(target)` | `target: string`                                                                                   | `ThoughtSummaryDTO \| null` | `md-preview/index.tsx`, `md-editor/index.tsx`                    |
...
| `shared/md-editor`                  | `thought.resolveWikiLinkTarget`, `thought.listThoughts`, `asset.saveAsset`                                                                                                  | `ThoughtSummaryDTO`                                                                                        |
| `shared/md-preview`                 | `thought.resolveWikiLinkTarget`                                                                                                                                             | —                                                                                                          |
