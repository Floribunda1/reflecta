...
export const PI_TOOL_LABELS: Record<PiToolName, string> = {
  ...
  edit: "修改文件",
  write: "写入文件",
  domain_list: "列出 Domain",
  domain_inspect: "查看 Domain",
  understanding_list: "列出 Understanding",
  understanding_get: "读取 Understanding",
  context_list: "列出 Context",
  context_get: "读取 Context",
  attachment_read: "读取附件",
  retrieve_knowledge: "检索知识",
  canvas_read: "读取画布",
  canvas_list: "列出画布",
  canvas_search: "搜索画布",
  understanding_create: "候选 Understanding",
  understanding_update: "候选修改 Understanding",
  understanding_delete: "候选删除 Understanding",
  domain_create: "候选 Domain",
  domain_update: "候选修改 Domain",
  domain_delete: "候选删除 Domain",
  context_create: "候选 Context",
  context_update: "候选修改 Context",
  context_delete: "候选删除 Context",
  canvas_create: "候选画布",
  canvas_update: "候选修改画布",
  canvas_delete: "候选删除画布",
  web_search: "搜索网页",
  source_check: "核验观点",
  fetch_content: "读取网页",
