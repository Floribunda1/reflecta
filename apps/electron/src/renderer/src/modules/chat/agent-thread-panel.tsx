...
function AgentThreadTitle({
  ...
  return (
    <Input
      ...
      className="h-8 min-w-0 flex-1 field-sizing-content border-0 dark:bg-transparent bg-transparent px-0 text-sm font-medium shadow-none focus-visible:ring-0"
      placeholder="新对话"
    />
  );
}
