...
Follow the established coding standards from the project's `AGENTS.md` (and related docs under `docs/references/technical/`, e.g. `frontend-guide.md` for frontend code), including:
