...
export const addThoughtConnectionAction = {
  name: "add_thought_connection",
  description: "Mutates Reflecta. Add a directed thought connection. Requires confirm: true.",
  mutates: true,
  inputSchema,
